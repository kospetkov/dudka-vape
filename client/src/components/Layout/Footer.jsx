...
const Footer = () => {
    ...
    const { storeName, logoUrl, contactEmails, contactPhones, address, workingHours, socialLinks } = useSettings();
        ...
        <footer className="footer">
            <div className="container">
                <div className="footer-grid">
                    ...
                    <div className="footer-section">
                        <div className="footer-brand">
                            {logoUrl && <img src={logoUrl} alt={storeName} className="footer-logo" />}
                        </div>
                    ...
                    <div className="footer-section">
                        ...
                        <ul className="footer-contact">
                            {contactEmails?.length > 0 && contactEmails.map((email, idx) => (
                                email && (
                                    <li key={`email-${idx}`}>
                                        <strong>Email:</strong>
                            ...
                            {contactPhones?.length > 0 && contactPhones.map((phone, idx) => (
                                phone && (
                                    <li key={`phone-${idx}`}>
                            ...
                            {workingHours && (
                                <li>
                                    ...
                                    <span>
                                        {workingHours.weekdays && `Пн-Пт: ${workingHours.weekdays}`}
                                        {workingHours.saturday && `, Сб: ${workingHours.saturday}`}
                                    </span>
                                </li>
                            )}
                        </ul>
                ...
                <div className="footer-bottom">
                    <p>© {new Date().getFullYear()} {storeName || 'Store'}. Всі права захищено.</p>
